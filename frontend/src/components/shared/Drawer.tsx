  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <aside
        ...
        aria-modal="true"
        aria-label={title}
        className="relative flex h-full w-[480px] max-w-full animate-slide-in-right flex-col border-l border-border bg-card shadow-drawer"
      >
...
export function DrawerBody({ children }: { children: ReactNode }) {
  return <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6">{children}</div>;
}
